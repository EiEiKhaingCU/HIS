...
namespace HospitalMangementSystem_EiEiKhaing_.Controllers
{
    public class DoctorsController : Controller
    {
        ...
        {
            var hospitalContext = _context.Doctor.Include(d => d.Specialist);
        ...
        {
            ViewData["SpecialistId"] = new SelectList(_context.Specialist, "Id", "Name");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Email,PhoneNo,Gender,NRC,DoctorNRC,MedicalLicence,SpecialistId")] Doctor doctor)
        {
