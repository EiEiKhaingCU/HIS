...
namespace HospitalMangementSystem_EiEiKhaing_.Controllers
{
    public class AppointmentsController : Controller
    {
        ...
        {
            var hospitalContext = _context.Appointment.Include(a => a.Doctor).Include(a => a.Patient).Include(a => a.Room);
        ...
        public async Task<IActionResult> Create([Bind("Id,AppointDate,TreateDate,StartDate,EndDate,VokingNo,PatientId,DoctorId,RoomId")] Appointment appointment)
        {
